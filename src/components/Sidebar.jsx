...
function Sidebar({ isOpen = false, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`border-border bg-surface fixed inset-y-0 right-0 z-50 flex h-screen w-72 flex-col justify-between border-l p-4 shadow-2xl transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:z-0 lg:w-75 lg:translate-x-0 lg:border-r-0 lg:shadow-[1px_0_20px_rgba(0,0,0,0.01)] lg:backdrop-blur-xl ${
        ...
        <div className="border-border/40 border-t pt-4">
          ...
          >
            <div className="flex items-center gap-x-3">
              ...
              <div className="flex flex-col">
                <span className="text-foreground line-clamp-1 text-xs font-black">
            ...
            <div className="flex shrink-0 items-center gap-x-1">
              <Link href="/me" aria-label="تنظیمات پروفایل">
                <Button
                  isIconOnly
                  size="sm"
                  variant="flat"
                  className="bg-default/50 rounded-xl"
                >
                  <svg
                    className="h-4 w-4"
                    viewBox="0 0 24 24"
