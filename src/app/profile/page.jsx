  ...
  return (
    ...
    >
      ...
      <section className="grid gap-4 md:grid-cols-2">
        {/* محصولات پسندیده */}
        <div className="border-danger/10 bg-surface from-danger/15 rounded-[28px] border bg-linear-to-br to-transparent p-6">
        ...
        {/* محصولات */}
        <div className="border-warning/10 bg-surface from-warning/15 rounded-[28px] border bg-linear-to-br to-transparent p-6">
