...
export default function MobileFilter({ totalProducts }) {
  ...
  return (
    <>
      {/* 📱 دکمه چسبان فیلتر مخصوص موبایل (هماهنگ شده با bg-surface صلب تم) */}
      <div className="border-border bg-surface sticky top-20 z-30 mb-6 flex w-full items-center justify-between rounded-2xl border p-3 shadow-md lg:hidden">
        ...
        <button
          ...
          className="bg-accent/10 text-accent border-accent/20 flex items-center gap-2 rounded-xl border px-4 py-2 text-xs font-black shadow-sm transition-transform active:scale-95"
        >
      ...
      {/* 📱 منوی فیلتر کشویی اختصاصی موبایل (Bottom Sheet Drawer) */}
      <div
      ...
      >
        {/* لایه تیره پس‌زمینه پشت کشو */}
        <div
          onClick={() => setIsOpenFilter(false)}
          className="absolute inset-0 bg-black/60 backdrop-blur-[2px] transition-opacity"
        />

        {/* کشوی متحرک: کاملاً متصل به bg-surface صلب تم بدون ترنسپرنتی */}
        <div
        ...
        >
          ...
          {/* سربرگ کشو با رنگ تم ثابت و خط جداکننده مشخص */}
          ...
          {/* ⚡ بدنه محتوای فیلترها (کاملاً منطبق با رنگ پس‌زمینه پویا) */}
          ...
          {/* دکمه اکشن نهایی در پایین با بک‌گراند صلب برای پوشاندن محتوای اسکرول زیرین */}
