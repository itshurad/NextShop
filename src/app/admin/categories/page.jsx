...
function page() {
  ...
  const { mutateAsync, isLoading: removing } = useRemoveCategory();
    ...
    <div className="space-y-8">
      ...
      <div className="border-accent/20 from-accent/15 via-accent/5 relative overflow-hidden rounded-[32px] border bg-linear-to-br to-transparent p-8">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="text-4xl font-black">دسته‌بندی‌ها</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="border-danger/10 from-danger/15 rounded-[28px] border bg-linear-to-br to-transparent p-6">
          <div className="text-danger-soft-foreground bg-danger/15 mb-5 flex h-12 w-12 items-center justify-center rounded-2xl text-2xl">
            <svg
              className="h-6 w-6"
              viewBox="0 0 24 24"
              fill="none"
      ...
      {isLoading ? (
        ...
        <div className="border-default-200 bg-surface rounded-[32px] border p-20 text-center">
          ...
          <h3 className="text-2xl font-black">هنوز دسته‌بندی‌ای وجود ندارد</h3>
        ...
        <div className="border-default-200 bg-surface overflow-hidden rounded-[32px] border p-2 shadow-xl shadow-black/5">
          {/* Table Header */}
          <div className="p-6">
            <h2 className="text-lg font-black">لیست دسته‌بندی‌ها</h2>
                  ...
                  {categories?.map((category, index) =>
                    isLoading ? (
                      ...
                      <Table.Row key={index}>
                        ...
                        <Table.Cell>
                          <Chip
                            variant={categoryTypes[category.type].variant}
                            color={categoryTypes[category.type].color}
                          >
                            {categoryTypes[category.type].label}
                          </Chip>
                        </Table.Cell>
                        <Table.Cell>
