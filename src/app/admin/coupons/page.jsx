...
function page() {
  ...
  const { coupons } = data || {};
  const { mutateAsync, isLoading: isDeleting } = useRemoveCoupon();
    ...
    <div className="space-y-8">
      ...
      <div className="border-accent/20 from-accent/15 via-accent/5 relative overflow-hidden rounded-[32px] border bg-linear-to-br to-transparent p-8">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="text-4xl font-black">کدهای تخفیف</h1>
      ...
      {isLoading ? (
        ...
        <div className="border-default-200 bg-surface rounded-[32px] border p-20 text-center">
          ...
          <h3 className="text-2xl font-black">هنوز کد تخفیفی ثبت نشده است</h3>{" "}
        ...
        <div className="border-default-200 bg-surface overflow-hidden rounded-[32px] border p-2 shadow-xl shadow-black/5">
          {/* Table Header */}
          <div className="p-6">
            <h2 className="text-lg font-black">لیست کد تخفیف</h2>
            ...
            <Table.ScrollContainer>
              <Table.Content dir="rtl" className="text-center">
                <Table.Header className="text-nowrap">
                  ...
                  <Table.Column>شامل کد تخفیف</Table.Column>
                  <Table.Column>مقدار مصرفی</Table.Column>
                ...
                <Table.Body className="text-nowrap">
                  {coupons?.map((coupon, index) => (
                    <Table.Row key={coupon._id}>
                      ...
                      <Table.Cell>{formatNumber(coupon.amount)} عدد</Table.Cell>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        {formatNumber(coupon.usageCount)} عدد
                      </Table.Cell>
                      <Table.Cell>
                        {formatNumber(coupon.usageLimit)} عدد
                      </Table.Cell>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Button
                            onClick={() => handleDeleteProduct(coupon._id)}
                            variant="danger-soft"
                            className="size-10"
                          >
                            {isDeleting ? (
